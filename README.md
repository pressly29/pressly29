...
I'm a software engineer with hands-on experience building real-time dashboards and logistics systems, currently sharpening my data science skills with an MSc while running a small design studio and building fintech side projects on the side.

### 🔭 What I'm doing right now

- 🎓 Studying for an **MSc in Data Analytics** at the University of Portsmouth
- 🤖 Doing **AI training & evaluation work** — trajectory annotation, rubric design, hallucination evaluation — via OpenClaw / OpenTrain
- 📈 Building **EvPNova**, a prediction-market trading system that pulls signal from NOAA, USGS, NASA FIRMS and Manifold data
- 🎨 Running **Pressly Design Studios**, a digital design studio (branding, social, marketing collateral)
- 👀 **Open to** software engineering, data analytics, and AI annotation/evaluation roles
...
![Superset](https://img.shields.io/badge/-Apache%20Superset-FF5733?style=flat-square)
